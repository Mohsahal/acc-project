...
const ViewInvoice = () => {
  ...
  const handleSearch = () => {
    console.log("Searching invoices...", formData);
  };

  const handleReset = () => {
    setFormData({ client: "", invoiceNumber: "" });
  };

  const handleMultipleDelete = () => {
    console.log("Deleting multiple invoices...", selectedInvoices);
  };
  ...
  const sidebarItems = [
    ...
    { 
      ...
      subItems: [
        ...
        { label: "View", path: "/invoice/view", active: true },
  ...
  const invoices = [
    {
      ...
      clientCustomer: "CLICK COMPUTER DUPLICATE",
      clientCustomerPh: "+971 042397456",
      clientCustomerTRN: "102369874500003",
      clientCustomerType: "customer",
      paymentTerms: "",
    ...
    },
    {
      id: "2",
      clientName: "CLICK COMPUTER LLC",
      clientCustomer: "KVM GEN TRDG LLC",
      clientCustomerPh: "+971 043361202",
      clientCustomerTRN: "100278814700003",
      clientCustomerType: "supplier",
      paymentTerms: "",
      invoiceType: "purchase",
      lastUpdatedBy: "admin/admin",
      status: "done"
    },
    {
      id: "3",
      clientName: "CLICK COMPUTER LLC",
      clientCustomer: "ALTHANAA TRDG CO",
      clientCustomerPh: "+97143936405",
      clientCustomerTRN: "100330999200003",
      clientCustomerType: "supplier",
      paymentTerms: "",
      invoiceType: "purchase",
      lastUpdatedBy: "admin/admin",
      ...
      <header className="bg-blue-600 text-white px-6 py-4 flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-xl font-semibold">Invoice 400</h1>
          </div>
        </div>
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-2">
          ...
          <div className="max-w-7xl mx-auto space-y-6">
              ...
              <CardContent className="p-6">
                ...
                <div className="mt-4 flex items-center justify-between">
                  <p className="text-sm text-gray-600">
                    Showing 1-20 of 1,496,135 items.
                  </p>
                  <div className="flex items-center space-x-2">
                    <Checkbox 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {invoices.map((invoice) => (
                <Card key={invoice.id} className="bg-white shadow-lg border border-gray-200">
                  <CardContent className="p-4">
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start justify-between">
                        ...
                        />
                        <div className="w-16 h-20 bg-gray-200 rounded border-2 border-dashed border-gray-300 flex items-center justify-center">
                      ...
                      {/* Client Name */}
                      <div>
                        <h3 className="font-bold text-gray-800 text-lg">{invoice.clientName}</h3>
                      </div>

                      {/* Invoice Details */}
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          <span className="text-gray-600">Client Customer:</span>
                          <span className="font-medium">{invoice.clientCustomer}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600">Client Customer Ph:</span>
                          <span className="font-medium">{invoice.clientCustomerPh}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600">Client Customer TRN:</span>
                          <span className="font-medium">{invoice.clientCustomerTRN}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600">Client Customer Type:</span>
                          <span className="font-medium">{invoice.clientCustomerType}</span>
                        </div>
                        <div className="flex justify-between">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">{invoice.lastUpdatedBy}</span>
                        </div>
                        <div className="flex justify-between">
                      ...
                      <div className="grid grid-cols-2 gap-2 pt-2">
                        <Button className="bg-blue-600 hover:bg-blue-700 text-white text-xs py-1 h-8">
                          Update
                        </Button>
                        <Button className="bg-blue-600 hover:bg-blue-700 text-white text-xs py-1 h-8">
                        ...
                        <Button className="bg-green-600 hover:bg-green-700 text-white text-xs py-1 h-8">
                          <User className="h-3 w-3 mr-1" />
                          View Customer/Supplier
                        </Button>
                        <Button className="bg-red-600 hover:bg-red-700 text-white text-xs py-1 h-8">
